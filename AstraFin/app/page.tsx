              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Track expenses, set savings goals, and get personalized
                    investment recommendations all in one place.
                  </p>
                </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-4">
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Add, edit, and delete transactions with ease. Filter by
                    category, date, and type.
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Visualize your spending patterns and get AI-powered
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Get personalized investment strategies based on your
                    financial profile.
                  </p>
                </CardContent>
              </Card>
